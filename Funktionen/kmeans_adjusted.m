function varargout = kmeans_adjusted(X, k, varargin)
%KMEANS_ADJUSTED this is the matlab function kmeans expanded by additional distance functions
% add distance functions in:
% * values of cell array *distNames*
% * switch case functions using distance (search: *switch distance*)
%
...
% add name of additional distance functions HERE
% add case in switch distance functions
distNames = {'sqeuclidean','cityblock','cosine','correlation','hamming', 'geh', 'euclidean_mit_nan'};
